...
@Database(entities = {ManitobaHistoricalSite.class, SitePhotos.class, SiteSource.class, SiteType.class, SiteWithType.class }, version = 1)
public abstract class HistoricalSiteDatabase extends RoomDatabase {
    ...
    public abstract SiteWithTypeDao siteWithTypeDao ();
